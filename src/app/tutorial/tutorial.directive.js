...
/**
 * @ngdoc directive
 * @name wordCloudChrome.directive:fielddbTutorial
 * @description
 * # fielddbTutorial
 */
angular.module("wordCloudChrome").directive("tutorialSlider", function() {
  return {
    ...
    $scope.tutorialpopups = ["tutorialExplanationSlide", "tutorialBeginSlide", "tutorialEditSlide", "tutorialFinishSlide"];
    var currentPopUp = "";
